...
<input class="{eq( $html_class, 'half' )|choose( 'box', 'halfbox' )}" type="text" size="70" name="{$attribute_base}_mugovalidatedstring_data_text_{$attribute.id}" value="{$data_text|wash()}" />
{/let}
{/default}